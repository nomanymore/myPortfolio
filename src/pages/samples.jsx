                ...
                {selectedSection === 'data' && (
                    <div className="w-3/4 mx-auto">
                        <div className="bg-white bg-opacity-90 p-6 m-4 rounded-xl shadow-lg w-1/2 ">
                            <iframe title="NY resolutions" width="271" height="159" src="https://app.powerbi.com/view?r=eyJrIjoiOWVmMWE2OGQtMDExMC00N2RmLTk1YTEtOWQ2Mzc2MTA5NWQyIiwidCI6IjlmMjlkOTFmLWYzM2EtNGY4NC05ZDU2LWE0NGQ4ODk0YTA0NiJ9&embedImagePlaceholder=true&pageName=ReportSection" frameborder="0" allowFullScreen="true"></iframe>
