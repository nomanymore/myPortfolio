                ...
                {selectedSection === 'web' && (
                    <div className="flex flex-wrap justify-center ">
                        ...
                        {selectedSection === 'data' && (
                            ...
                            <iframe title="NY resolutions" width="640" height="241" src="https://app.powerbi.com/view?r=eyJrIjoiOWVmMWE2OGQtMDExMC00N2RmLTk1YTEtOWQ2Mzc2MTA5NWQyIiwidCI6IjlmMjlkOTFmLWYzM2EtNGY4NC05ZDU2LWE0NGQ4ODk0YTA0NiJ9&embedImagePlaceholder=true&pageName=ReportSection" frameborder="0" allowFullScreen="true"></iframe>
                        ...
                        <div className="bg-white bg-opacity-90 p-4 m-4 rounded-xl shadow-lg w-1/2">
                        <iframe title="IT job fair" width="640" height="241" src="https://app.powerbi.com/view?r=eyJrIjoiY2M2YzA4YjQtYjAzYS00YmIwLTgyMDMtOGIyYWQxMGQ1M2I3IiwidCI6IjlmMjlkOTFmLWYzM2EtNGY4NC05ZDU2LWE0NGQ4ODk0YTA0NiJ9" frameborder="0" allowFullScreen="true"></iframe>
